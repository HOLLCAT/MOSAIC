<template>
    <div class="items-center w-full p-4 sm:p-12.5 flex flex-col flex-shrink h-auto min-h-screen justify-center items-center">
        <div class="flex flex-col items-center rounded-3xl bg-purple w-2/3">
            <h1 class="text-2xl text-white font-semibold pt-10 xs:text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl">About</h1>
            <p class="text-xs text-white mt-10 text-center w-4/5 h-2/5 mb-20 text-justify xs:text-base sm:text-md md:text-1xl lg:2xl xl:text-2xl">
